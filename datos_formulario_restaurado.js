// Restaurado desde Nuevo_Formulario/incidencias/views.py (DATOS_MODULOS_ESTANQUES)
window.DATOS_MODULOS = {
  'Trafún': {
...
// Los operarios se cargan vía API (get_operarios.php)
window.DATOS_OPERARIOS = window.DATOS_OPERARIOS || {};
